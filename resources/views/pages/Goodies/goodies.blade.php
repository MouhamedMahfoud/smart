    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 section-intro text-center" data-aos="fade-up">
                <h1>Branding & Graphisme </h1>
                <div class="divider"></div>
                <div>
                    <p class="text-start">
                        Études chromatiques, iconographiques et typographiques Réalisation planches de tendances
                        Création graphique sur mesure dans les règles de l’art, conforme aux normes et exigences
                        métier Mise en situation de votre identité sur différents supports (mockups) Mise à disposition
                        de tous les droits légaux d’utilisation Élaboration d’un guide complet d’utilisation de votre
                        charte graphique
                    </p>
                </div>
...
<section id="SOMME-NOUS">
    <div class="container">
        <div class="row">
            <div class="col-md-12 section-intro text-center" data-aos="fade-up">
                <h1>Le design au cœur de la stratégie de notre agence de communication</h1>
                <div class="divider"></div>
                <div>
                    <p class="text-start">
                       Parce que notre métier est d’imaginer, d’inventer, d’innover et aussi de surprendre, nous avons dès le début de notre aventure placer le design au cœur de notre stratégie <b>d’agence de communication</b> et de notre <b>studio de création graphique</b>.
                    </p>
                    <p class="text-start">
                    Toutes nos compétences <b>publicitaires</b>, créatives et techniques, se mobilisent au quotidien pour être à votre écoute, pour comprendre vos besoins, appréhender vos goûts et vous proposer des <b>projets de communication</b> sur-mesure conformes à vos attentes et quels que soient les supports de diffusion choisis :
                    </p>
                    <p class="text-start">
                    <b>Création ou refonte de logos, chartes graphiques, création</b> de site Web, <b>conception</b> de cartes commerciales, dépliants, affiches, flyers / tracts, tracts, plaquettes commerciales, pochettes à rabats, pochettes CD ou DVD, brochures, menus de restaurant, plaquettes tarifs, sets de table, en-têtes de lettre, suite de lettre, cartes de correspondance, enveloppes, carnets autocopiants, etc.
                    </p>
                </div>
