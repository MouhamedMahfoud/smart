...
@section('content')
<!-- Start home  -->
<section id="" class="bg-cover hero-section">
    <div class="home-slider owl-carousel js-fullheight">
        <div class="slider-item js-fullheight" style="background-image: url(img/reseauxSociaux/1.jpg)">
            <div class="overlay"></div>

        </div>
        <div class="slider-item js-fullheight" style="background-image: url(img/reseauxSociaux/2.png)">
            <div class="overlay"></div>

        </div>
        <div class="slider-item js-fullheight" style="background-image: url(img/reseauxSociaux/3.jpg)">
            <div class="overlay"></div>

        </div>
        <div class="slider-item js-fullheight" style="background-image: url(img/reseauxSociaux/4.jpg)">
            <div class="overlay"></div>

        </div>
        <div class="slider-item js-fullheight" style="background-image: url(img/reseauxSociaux/5.png)">
            <div class="overlay"></div>

        </div>
        <div class="slider-item js-fullheight" style="background-image: url(img/reseauxSociaux/7.png)">
            <div class="overlay"></div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 section-intro text-center" data-aos="fade-up">
                ...
                <div>
                    <p class="text-start">
                        Création et paramétrage des comptes Élaboration stratégie (ligne éditoriale, planning de publication, recherche mots clés #hashtags...) Création des visuels, animations, vidéos, et contenus rédactionnels Développement relations influenceurs, partenariats, liens croisés Gestion de communauté (réponses aux commentaires, messages et avis...) Organisation de concours Mise en place de campagnes de publicité
                    </p>
                </div>
...
<!-- End QUI SOMME-NOUS -->
<!-- Start service -->
<section id="" class="services color-seconde text-center bg-light">
    <div class="container">
...
<section id="" class="services color-seconde text-center ">
    <div class="container">
