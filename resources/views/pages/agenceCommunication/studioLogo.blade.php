    ...
    <div class="container">
        ...
        <div class="row g-2">
            ...
            <div class="col-md-6 ">
                <div class="row g-2">
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/26.jpeg" id="myImg2" onclick="openModal('myImg2', 'myModal2');" alt="" />
                                <!-- The Modal -->
            ...
            <div class="col-md-6 studio-img">
                <div class="studio image-popup">
                    <div class="service-img">
                        <img class="stidioIm" src="img/logo/7.jpg" id="myImg6" onclick="openModal('myImg6', 'myModal6');" alt="" />
                        <!-- The Modal -->
            ...
            <div class="col-md-6 ">
                <div class="row g-2">
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/10.webp" id="myImg7" onclick="openModal('myImg7', 'myModal7');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/11.png" id="myImg8" onclick="openModal('myImg8', 'myModal8');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/12.png" id="myImg9" onclick="openModal('myImg9', 'myModal9');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/13.avif" id="myImg10" onclick="openModal('myImg10', 'myModal10');" alt="" />
                                <!-- The Modal -->
            ...
            <div class="col-md-6 studio-img">
                <div class="studio image-popup">
                    <div class="service-img">
                        <img class="stidioIm" src="img/logo/15.jpg" id="myImg11" onclick="openModal('myImg11', 'myModal11');" alt="" />
                        <!-- The Modal -->
            ...
            <div class="col-md-6 ">
                <div class="row g-2">
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/17.jpg" id="myImg12" onclick="openModal('myImg12', 'myModal12');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/18.webp" id="myImg13" onclick="openModal('myImg13', 'myModal13');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/19.avif" id="myImg14" onclick="openModal('myImg14', 'myModal14');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/20.jpg" id="myImg15" onclick="openModal('myImg15', 'myModal15');" alt="" />
                                <!-- The Modal -->
            ...
            <div class="col-md-6 studio-img">
                <div class="studio image-popup">
                    <div class="service-img">
                        <img class="stidioIm" src="img/logo/27.jpg" id="myImg16" onclick="openModal('myImg16', 'myModal16');" alt="" />
                        <!-- The Modal -->
            ...
            <div class="col-md-6 ">
                <div class="row g-2">
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/22.avif" id="myImg17" onclick="openModal('myImg17', 'myModal17');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/24.jpg" id="myImg18" onclick="openModal('myImg18', 'myModal18');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/25.jpg" id="myImg19" onclick="openModal('myImg19', 'myModal19');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img class="stidioIm-min" src="img/logo/26.jpeg" id="myImg20" onclick="openModal('myImg20', 'myModal20');" alt="" />
                                <!-- The Modal -->
