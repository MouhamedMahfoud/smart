    ...
    <div class="container">
        ...
        <div class="row g-2">
            ...
            <div class="col-md-6 studio-img">
                <div class="studio image-popup">
                    <div class="service-img">
                        <img src="img/agenceCommunication/studio/2.jpeg" id="myImg1" onclick="openModal('myImg1', 'myModal1');" alt="" />
                        <!-- The Modal -->
            ...
            <div class="col-md-6 ">
                <div class="row g-2">
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/4.jpg" id="myImg2" onclick="openModal('myImg2', 'myModal2');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/5.jpg" id="myImg3" onclick="openModal('myImg3', 'myModal3');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/13.jpg" id="myImg4" onclick="openModal('myImg4', 'myModal4');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/1.jpg" id="myImg5" onclick="openModal('myImg5', 'myModal5');" alt="" />
                                <!-- The Modal -->
            ...
            <div class="col-md-6 studio-img">
                <div class="studio image-popup">
                    <div class="service-img">
                        <img src="img/agenceCommunication/studio/std1.jpg" id="myImg6" onclick="openModal('myImg6', 'myModal6');" alt="" />
                        <!-- The Modal -->
            ...
            <div class="col-md-6 ">
                <div class="row g-2">
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/ham.jpg" id="myImg7" onclick="openModal('myImg7', 'myModal7');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/std2.jpg" id="myImg8" onclick="openModal('myImg8', 'myModal8');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/std3.jpg" id="myImg9" onclick="openModal('myImg9', 'myModal9');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/std4.jpg" id="myImg10" onclick="openModal('myImg10', 'myModal10');" alt="" />
                                <!-- The Modal -->
            ...
            <div class="col-md-6 studio-img">
                <div class="studio image-popup">
                    <div class="service-img">
                        <img src="img/agenceCommunication/studio/ham.jpg" id="myImg11" onclick="openModal('myImg11', 'myModal11');" alt="" />
                        <!-- The Modal -->
            ...
            <div class="col-md-6 ">
                <div class="row g-2">
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/std5.jpg" id="myImg12" onclick="openModal('myImg12', 'myModal12');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/std6.jpg" id="myImg13" onclick="openModal('myImg13', 'myModal13');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/std7.jpg" id="myImg14" onclick="openModal('myImg14', 'myModal14');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/std8.jpg" id="myImg15" onclick="openModal('myImg15', 'myModal15');" alt="" />
                                <!-- The Modal -->
            ...
            <div class="col-md-6 studio-img">
                <div class="studio image-popup">
                    <div class="service-img">
                        <img src="img/agenceCommunication/studio/std9.jpg" id="myImg16" onclick="openModal('myImg16', 'myModal16');" alt="" />
                        <!-- The Modal -->
            ...
            <div class="col-md-6 ">
                <div class="row g-2">
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/std10.jpg" id="myImg17" onclick="openModal('myImg17', 'myModal17');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/std11.jpg" id="myImg18" onclick="openModal('myImg18', 'myModal18');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/std12.jpg" id="myImg19" onclick="openModal('myImg19', 'myModal19');" alt="" />
                                <!-- The Modal -->
                    ...
                    <div class="col-md-6 ">
                        <div class="studio image-popup">
                            <div class="service-img">
                                <img src="img/agenceCommunication/studio/std13.jpg" id="myImg20" onclick="openModal('myImg20', 'myModal20');" alt="" />
                                <!-- The Modal -->
